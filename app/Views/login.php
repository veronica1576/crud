        ...
        <div class="tab-content">
          <div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
            <form method="POST" action="<?=site_url('/login')?>">
              ...
              <!-- Submit button -->
              <button type="submit" class="btn btn-primary btn-block mb-4" onclick="ingresar()">Ingresar</button>
...
// EMPIEZA CODIGO AJAX
  function loginFunction(loginPassword,loginName){
    var paremetros =
    {
    ...
    $.ajax({
      ...
      success: function(mensa_mos)
      {
        $('#ID_M_I').html(mensaje-mostr);
      }
    });
  }
</script>
